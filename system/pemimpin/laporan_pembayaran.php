        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <img style="float: left;" src="../../assets/img/logo-bines.jpg" alt="logo" width="90" height="85">
                            ...
                            <div class="card-body">
                                ...
                                <h4 style="text-transform: capitalize; margin: 0;" align="right"><?php echo $_SESSION['username']; ?>,</h6>
                                    <br>
