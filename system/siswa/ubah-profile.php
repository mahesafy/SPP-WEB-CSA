...
echo '<title>UBAH PROFILE SISWA </title>';
                ...
                <div class="card-body">
                    <form action="" method="post" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="nisn" value="<?php echo $data['nisn']; ?>" readonly id="nis" type="text" autocomplete="off" class="form-control form-control-warning" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="nis" value="<?php echo $data['nis']; ?>" readonly id="nis" type="text" autocomplete="off" class="form-control form-control-warning" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2" for="password">Password Baru</label>
                            <div class="col-sm-10">
                                <input name="password" id="password" type="password" required class="form-control form-control-success">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10 offset-sm-2">
                                <input type="submit" name="submit" class="btn btn-dark text-white" value="Save" onClick="return confirm('Yakin Ubah Profile?');">
                            </div>
                        </div>
                    </form>
                </div>
...
if (isset($_POST["submit"])) {
    ...
    $sql = mysqli_query($conn, "UPDATE siswa SET  nisn='$nisn', nis='$nis', nama='$nama', password='$pass', id_kelas='$nm_kelas', alamat='$alamat', no_tlp='$tlp',id_spp='$id_spp' WHERE nisn='$id_siswa'");

    if ($sql) { ?>

        <script>
            alert("Data Berhasil di Ubah!");
            window.location.href = "profile.php?pesan=ubah-profile-berhasil";
        </script>
<?php
    } else {
