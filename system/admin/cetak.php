...
$pdf->SetX(0);
$pdf->MultiCell(30.5, 0.5, 'SMKN BINA ESSA', 0, 'C');
$pdf->SetFont('Times', 'B', 12);
$pdf->SetX(0);
// $pdf->MultiCell(30.5, 0.5, 'Telpon : 0038XXXXXXX', 0, 'C');
$pdf->SetX(0);
$pdf->MultiCell(30.5, 0.5, 'JL. cihanjuang km. 1,5 No.69 Kel. Citereup Kec. Cimahi Utara ', 0, 'C');
$pdf->SetX(0);
$pdf->MultiCell(30.5, 0.5, 'Telp/Fax : (022)87805857 Email : smkbines@yahoo.com Kota Cimahi 40512', 0, 'C');
...
$pdf->Cell(47, 0, "Admin, " . $p["nama_user"], 0, 1, 'C');
