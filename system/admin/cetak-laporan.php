...
<body>
    ...
    <h4 align="right" style="text-transform: capitalize;"><?php echo $data['nama_user']; ?></h4>

    <br>
    <h3><a class="no-print" href="transaksi.php" style="margin-right: 3%;"><i class="fa fa-sign-out"></i></a>
</body>
