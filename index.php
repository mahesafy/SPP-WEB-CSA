...
<body>
    ...
    <header class="pt-5">
        <div class="container pt-4 pt-xl-5" style="margin-bottom: 51px;padding-top: 66px;margin-top: -86px;">
            <div class="row pt-5" style="margin-bottom: 94px;margin-right: -12px;padding-bottom: 64px;padding-top: 0px;margin-top: 126px;">
